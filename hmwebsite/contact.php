...
<head>
  ...
  <title>Serenita Solare -CONTACT</title>
...
<body class="bg-light">
  ...
  <div class="my-5 px-4">
    <h2 class="fw-bold h-font text-center"><span style="color: #ec8211;">CONTACT US</span></h2>
      ...
      <div class="col-lg-6 col-md-6 mb-5 px-4">
        <div class="bg-white rounded shadow p-4">
          ...
          <a href="<?php echo $contact_r['gmap'] ?>" target="_blank" class="d-inline-block text-decoration-none text-dark mb-2">
            <i class="bi bi-geo-fill"></i> <?php echo $contact_r['address'] ?>
          </a>
