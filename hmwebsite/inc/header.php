...
<nav class="navbar navbar-expand-lg navbar-light bg-white px-lg-3 py-lg-2 shadow-sm sticky-top">
    <div class="container-fluid">
        <a class="navbar-brand me-5 fw-bold fs-3" href="index.php">Serenita<span style="color: #ffa343;">Solare</span></a>
                   ...
                   if(isset($_SESSION['login']) && $_SESSION['login']==true)
                   {
                    echo<<<data
                        ...
                        <ul class="dropdown-menu dropdown-menu-lg-end">
                            ...
                            <li><button class="dropdown-item" href="logout.php">logout</button></li>
                        </ul>
                        </div>
                    data;
                   }
            ...
            <form id="register-form">
                ...
                <div class="modal-body">
                    <span class="badge bg-light text-dark mb-3 text-wrap lh-base">
                        Note: Your details must match with your ID (Adhaar card, passport,etc.)
                    ...
                    <div class="text-center my-1">
                        <button type="submit" class="btn text-white shadow-none custom-bg">REGISTER</button>
                    </div>
                </div>
            </form>
        </div>
