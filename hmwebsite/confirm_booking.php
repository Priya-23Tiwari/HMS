...
<head>
  ...
  <title>Serenita Solare -CONFIRM BOOKING</title>
...
<body class="bg-light">
  ...
  <?php
    ...
    $user_res = select("SELECT * FROM `user_cred` WHERE `id`=?", [$_SESSION['uId']], "i");
  ...
  <div class="container">
    <div class="row">
      ...
      <div class="col-12 my-5 mb-4 px-4">
        <h2 class="fw-bold"><span style="color: #ec8211;">CONFIRM BOOKING</span></h2>
